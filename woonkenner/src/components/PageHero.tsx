  ...
  return (
    <div className="relative overflow-hidden bg-stone-900 pt-16">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        ...
        {badge && (<div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/10 rounded-full px-4 py-2 mb-6"><div className="w-2 h-2 bg-blue-400 rounded-full" /><span className="text-stone-300 text-sm font-medium">{badge}</span></div>)}
        <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold text-white leading-tight mb-4">{title}</h1>
        {highlightedSubtitle && <p className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-400 via-sky-300 to-cyan-400 bg-clip-text text-transparent mb-4">{highlightedSubtitle}</p>}
