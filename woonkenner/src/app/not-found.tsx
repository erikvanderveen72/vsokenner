      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10 max-w-2xl mx-auto">
          {[
            ...
            <Link key={link.href} href={link.href} className="flex items-center justify-center gap-2 bg-white border border-stone-200 rounded-xl px-4 py-3 text-stone-700 font-medium hover:border-blue-400 hover:shadow-md transition-all">
              {link.label} <ArrowRight size={16} className="text-blue-600" />
            </Link>
          ))}
        </div>

        <Link href="/" className="inline-flex items-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-blue-700 transition-colors">
