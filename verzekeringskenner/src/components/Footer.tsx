...
const columns = [
  ...
  { title: "Calculators", links: [
    { label: "Premie berekenen", href: "/zorgverzekering" },
    { label: "Autoverzekering vergelijken", href: "/autoverzekering" },
    { label: "Inboedel waarde berekenen", href: "/woonverzekeringen" },
  ]},
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="mb-10">
          <Link href="/" className="flex items-center gap-2.5">
            <svg width="34" height="34" viewBox="0 0 36 36" fill="none"><circle cx="18" cy="18" r="18" fill="#2563eb"/><circle cx="18" cy="18" r="14" fill="#1d4ed8"/><path d="M18 10l2 4h4l-3 3 1 4-4-2-4 2 1-4-3-3h4z" fill="#fff"/></svg>
            <span className="text-[22px] font-extrabold tracking-tight text-white">verzekeringskenner<span className="text-blue-400">.nl</span></span>
          </Link>
          <p className="mt-3 text-sm text-stone-500 max-w-md">Onafhankelijke informatie over verzekeringen in Nederland. Gratis calculators en advies voor consumenten.</p>
        </div>
        ...
        <div className="border-t border-stone-800 pt-6 text-center">
          <p className="text-xs text-stone-500">&copy; {new Date().getFullYear()} Verzekeringskenner.nl — Alle informatie is indicatief. Raadpleeg een verzekeringsadviseur voor persoonlijk advies.</p>
        </div>
      </div>
    </footer>
  );
